...
export default function BookCard({ book, index = 0 }: { book: Book; index?: number }) {
  ...
  return (
    <div className="w-full">
      <div className="relative aspect-[3/4] rounded-card overflow-hidden shadow-soft bg-cream-2">
        {showCover ? (
      ...
      <div className="pt-2.5 px-0.5">
        {book.nomorInventaris && (
          <span className="font-label font-bold text-[0.68rem] tracking-wide text-coral">
            No. Inv {book.nomorInventaris}
          </span>
        )}
